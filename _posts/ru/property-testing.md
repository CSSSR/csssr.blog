...
![Анализ функции](/posts/ru/property-testing/func_analyze/all.png)
...
Однако некоторые сущности не только отображаются, но и редактируются – тогда нам надо добавить также функцию _convertTo_. Она переведет структуру из представления фронтенда в исходную, которую мы сможем сохранить на бекенде.
...
![Матроскин](/posts/ru/property-testing/matroskin/all.png)
