...
coverImageAlt: 'Как мы автоматизировали обновление sitemap.xml на нашем сайте.'
author: 'Игорь'
tag: 'post'
---

**П**риём-приём! На связи Игорь — JS-разработчик команды «Восток». Представляю вам рассказ о том, как я, работая над задачей по [нашему сайту](http://csssr.ru), вынес решение в публичный NPM пакет.
