...
**Д**авайте посмотрим на простой пример фронтенд-кода:
...
![No first class](/posts/ru/side-effects/no-first-class/all.jpg)
...
![Scheme of control flow](/posts/ru/side-effects/analyze/all.svg)
...
Также в случае кода с <span class="no-wrap">сайд-эффектами</span> значительно усложняется рефакторинг. К примеру, удаление неиспользующегося кода:

![Delete unused code](/posts/ru/side-effects/complicate-refactoring/all.gif)
...
![Compose pure vs dirty](/posts/ru/side-effects/compose-pure-vs-dirty/all.svg)
...
![My tests is passed](/posts/ru/side-effects/bad-tests/all.png)

Так как функции с <span class="no-wrap">сайд-эффектами</span> зависят от внешнего мира и влияют на него неявно, то, соотвественно, чтобы корректно протестировать такую функцию, необходимо:
...
Если бы мы хотели протестировать код с <span class="no-wrap">сайд-эффектами</span> «честно», мы должны были написать что-то подобное:
...
![Undefined is not a function](/posts/ru/side-effects/undefined-is-not-function/all.jpg)
...
![Light Table](/posts/ru/side-effects/watches/all.png)
...
Но, как я отметил в [предыдущей своей статье](http://blog.csssr.ru/2017/04/25/property-testing/), крайне сложно определить какое-либо свойство для кода с <span class="no-wrap">сайд-эффектами</span> — за счет их непредсказуемости.

## Мелкие вредители, вредящие по-крупному

![Gremlin](/posts/ru/side-effects/gremlins/all.png)
...
![Top Down or Bottom up](/posts/ru/side-effects/vityaz/all.png)
...
<p>-- <cite>[Саймон Пейтон Джонс](http://fprog.ru/2010/issue6/interview-simon-peyton-jones/)</cite></p>
</Note>
...
![Dead knigth](/posts/ru/side-effects/vityaz-no-way/all.png)
...
![Cats cradle](/posts/ru/side-effects/cats-cradle/all.jpg)
...
![Pure tree](/posts/ru/side-effects/pure_tree/all.svg)
...
![Not pure tree](/posts/ru/side-effects/not_pure_tree/all.svg)
...
![Skynet](/posts/ru/side-effects/skynet/all.png)
...
![No side effects](/posts/ru/side-effects/haskell/all.png)
