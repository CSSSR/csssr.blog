...
<Canvas>
  <Story
    ...
    args={{
      color: 'green',
      withBorders: true,
      contentMdx: `<thead><tr><th /><th>Команда в вашем офисе</th><th>Команда в своем офисе</th><th>Распределенная команда</th></tr></thead><tbody><tr><th colspan=\"4\">Цель</th></tr><tr><th>«Скорая помощь» проекту</th><td>++</td><td>+</td><td>-</td></tr><tr><th>Поддержка разработки или новый функционал</th><td>+</td><td>+</td><td>+</td></tr><tr><th>Старт разработки</th><td>+</td><td>+</td><td>+</td></tr></tbody>`,
    }}
  >
    {Table.bind({})}
  </Story>
