...
<Meta title="Post/VerticalGap" decorators={[GridDecorator]}/>

export const VerticalGap = ({ contentMdx }) => {
  return (
    <>
...
# [`<VerticalGap />`](http://s.csssr.ru/UJ4QCUXM4/2021-05-13-15-48-40.jpg)

Тематический разрыв `<hr>`

Добавляет дополнительный вертикальный отступ в 30px на десктопе и 25 пикселей на мобильных.
## Результат
