...
const base = ({ breakpoints: { desktop, tablet, mobile }, withImage}) => css`
  ...
  .quote {
    ...
    `&::before {
        ...
        width: ${calcRem(48)};
        height: ${calcRem(32)};
        background-image: url(../public/assets/blog/components/quote/icons/quotes.svg);
    ...
    ${withImage &&
      `&::after {
        content: '';
        position: absolute;
        background-image: url(../../public/assets/blog/components/quote/icons/angle.svg);
        background-repeat: no-repeat;
  ...
  ${mobile.all} {
    ...
    .quote {
      ...
      &::after {
        ...
        width: ${calcRem(39)};
        height: ${calcRem(36)};
        background-image: url(../../public/assets/blog/components/quote/icons/mobile.all/quotes.svg);
      }
    }
